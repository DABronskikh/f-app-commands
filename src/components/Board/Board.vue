<template>
    ...
    <div v-else class="demo">
        ...
        <v-toolbar class="my-toolbar">
            ...
            <v-menu :close-on-content-click="false">
                ...
                <v-card class="pa-1 w200p">
                    ...
                    <v-img v-for="(el, idx) in bfOptions" :key="idx" :src="el.value" :lazy-src="el.value"
                           aspect-ratio="1" class="grey lighten-2 ma-2" @click="bf=el.value">
        ...
        <draggable
                v-if="draggableOff"
                class="pre root-box style-1 pl-2 " :style="{'background': `url('${bf}')`}" v-model="columns"
                   @change="onColumnMoved($event, columns)">
            <div class="scrollbar-box mt-4 mb-4 mr-2 ml-2" v-for="(column, index) in columns" :key="column.id">
                ...
                <draggable class="scrollbar fff column style-1  pa-1" v-model="column.tasks" item
                           @change="onTaskMoved($event, column)">

                    <div class="item" v-for="element in column.tasks" :key="element.id"
        ...
        <div
            ...
            <div class="scrollbar-box mt-4 mb-4 mr-2 ml-2" v-for="(column, index) in columns" :key="column.id">
                ...
                <div class="scrollbar fff column style-1  pa-1" v-model="column.tasks" item
                           @change="onTaskMoved($event, column)">
        ...
        <v-dialog v-model="dialogList" width="700">
            <v-card>
                <v-card-title class="headline  lighten-2">
                    <update-list-title :columnId="listActiv.columnId" :id="listActiv.list.id"
                                       :listTitle="listActiv.list.title" :list="listActiv.list"></update-list-title>
                </v-card-title>
